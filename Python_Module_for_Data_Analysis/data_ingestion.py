"""
This module contains functions for data ingestion, including querying data from a database and reading CSV files from the web.
"""
...
def query_data(engine, sql_query):
    """
    Query data from a database using SQLAlchemy.
    ...
    Returns:
    pandas.DataFrame: The DataFrame containing the queried data.
...
def read_from_web_CSV(URL):
    ...
    Exception: If an error occurs during reading the CSV from the web.
    """
    try:
        df = pd.read_csv(URL)
